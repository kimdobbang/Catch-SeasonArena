...
public class DeleteInventoryServiceImpl implements DeleteInventoryUseCase {
	...
	private final FindInventoryByIdAndMemberEmail findInventoryByIdAndMemberEmail;


	@Override
	public void deleteInventory(Long inventoryId, String userEmail) {
		InventoryEntity inventoryEntity = findInventoryByIdAndMemberEmail.findInventoryByIdAndMemberEmail(inventoryId, userEmail);
